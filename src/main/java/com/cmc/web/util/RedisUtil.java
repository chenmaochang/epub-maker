...
public class RedisUtil {
     ...
     * @param values   待添加的数据
     */
    public static void addToListRight(String listKey, long time, TimeUnit timeUnit, Object... values) {
        //绑定操作
        BoundListOperations<String, Object> boundValueOperations = redisUtil.redisTemplate.boundListOps(listKey);
        //插入数据
