...
public class CommonController {
    ...
    private void grabManga(String url, String startStr, String endStr) {
        ...
        EBookChapter cover = EBookChapter.builder().images(coverImages).build();
        ...
        for (int i = 0; i < chapterNodes.size(); i++) {
            ...
            if (chapterNode.outerHtml().contains("<li>")) {
                ...
                String chapterName = outHtml.toString();
                if (chapterName.equals(startStr) || touchStart) {
                    ...
                    String base64;
                    EBookChapter chapter = EBookChapter.builder().title(chapterName).build();
